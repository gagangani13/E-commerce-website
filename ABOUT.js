...
import BandMembers from "./BandMembers.png"
import { Card } from "react-bootstrap";

const ABOUT = () => {
  return (
    <Card className='d-flex align-items-center' style={{ top: "3rem" ,backgroundColor:'grey'}}>
      <Card.Img src={BandMembers} style={{width:'25%',height:'auto'}} alt="Band Members" />
      <p style={{fontSize:'xxx-large'}}>ABOUT</p>
        <Card.Text className="my-2rem">
